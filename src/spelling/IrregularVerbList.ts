...
export const irregularVerbList: VerbSpellingList = {
  // be is a special case of irregular verb, not presented here
  beat: { past: "beat", v3: "beaten" },
  become: { past: "became", v3: "become", ing: "becoming" },
  begin: { past: "began", v3: "begun", ing: "beginning" },
  ...
  catch: { past: "caught", v3: "caught", thirdSingular: "catches" },
  ...
  do: { past: "did", v3: "done", thirdSingular: "does" },
  ...
  fly: { past: "flew", v3: "flown", thirdSingular: "flies" },
  forget: { past: "forgot", v3: "forgotten", ing: "forgetting" },
  freeze: { past: "froze", v3: "frozen", ing: "freezing" },
  get: { past: "got", v3: "got", ing: "getting" },
  give: { past: "gave", v3: "given", ing: "giving" },
  go: { past: "went", v3: "gone", thirdSingular: "goes" },
  grow: { past: "grew", v3: "grown" },
  hang: { past: "hung", v3: "hung" },
  have: { past: "had", v3: "had", thirdSingular: "has", ing: "having" }, // note non-standard third singular "has" instead of "haves"
  ...
  teach: { past: "taught", v3: "taught", thirdSingular: "teaches" },
...
// printIrregularVerbTable();

export function printIrregularVerbTable(): void {
  console.log("\n%c" + "all the same:", ";font-weight:bold");
  Object.keys(irregularVerbList).forEach((key) => {
    const verb = irregularVerbList[key];
    if (key === verb.past && key === verb.v3) {
      console.log(`${key}, ${verb.past}, ${verb.v3}`);
    }
  });

  console.log("\n%c" + "base = past:", ";font-weight:bold");
  ...
  console.log("\n%c" + "all differs:", ";font-weight:bold");
  Object.keys(irregularVerbList).forEach((key) => {
    const verb = irregularVerbList[key];
